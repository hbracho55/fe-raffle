    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <CustomJumbotron 
          ...
          description2='Transferencia a nombre de Valeska Pizarro, cuenta corriente 019803583720 Banco Falabella. Rut 17729545-0, Whatsapp +56953621500. Por favor indicar en la transferencia el/los número(s) de tickets que se están pagando.'
        />
        <img
